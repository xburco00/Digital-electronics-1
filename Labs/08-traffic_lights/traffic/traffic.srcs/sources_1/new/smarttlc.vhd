...
------------------------------------------------------------------------
architecture Behavioral of smarttlc is
    ...
    constant c_DELAY_3SEC   : unsigned(5 - 1 downto 0) := b"1100";
    constant c_DELAY_0p5SEC : unsigned(5 - 1 downto 0) := b"0010";
    constant c_ZERO         : unsigned(5 - 1 downto 0) := b"0000";
